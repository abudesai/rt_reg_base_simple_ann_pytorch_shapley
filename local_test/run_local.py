    ...
    dir_tree = {
        "ml_vol": {
            "inputs": {
                "data_config": None,
                "data": {
                    "training": {"regressionBaseMainInput": None},
                    "testing": {"regressionBaseMainInput": None},
                },
            },
            "model": {
                "model_config": None,
...
def score(test_data, predictions, data_schema):
    ...
    rmse = mean_squared_error(
        predictions[target_col], predictions["prediction"], squared=False
    )
...
if __name__ == "__main__":
    ...
    for run_hpt in run_hpt_list:
        ...
        for dataset_name in datasets:
            ...
            results, local_explanations = run_train_and_test(
                dataset_name, run_hpt, num_hpt_trials
            )
